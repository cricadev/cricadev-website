<template lang="">
  <div class="overflow-x-hidden overflow-y-hidden">
    <div
      class="pt-20 pb-8 ml-6 font-black text-left text-xl3_m xss-m:text-xl4_m about-container lg-m:text-[12.5rem] 2xl-m:text-xl6_d lg-m:ml-0 lg-m:pt-32"
    >
