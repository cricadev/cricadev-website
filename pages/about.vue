<template lang="">
  <div class="overflow-x-hidden overflow-y-hidden">
    ...
    >
      ...
      <span
        class="overflow-x-hidden overflow-y-hidden content text-xs_m"
      ></span>
      <h3
      ...
      <span
        class="overflow-x-hidden overflow-y-hidden content1 text-xs_m"
      ></span>
    </div>
    <NuxtPage />
  </div>
  ...
  function mouseOverHandler(e) {
    if (e.target.className === "tagcloud--item") {
      if (!e.target.classList.contains("done")) {
        ...
        if (e.target.lastChild.nodeValue === "HTML") {
          e.target.style.color = "rgba(0,0,0,0)";
        ...
        if (e.target.lastChild.nodeValue === "CSS") {
          e.target.style.color = "rgba(0,0,0,0)";
        ...
        if (e.target.lastChild.nodeValue === "GITHUB") {
          e.target.style.color = "rgba(0,0,0,0)";
        ...
        if (e.target.lastChild.nodeValue === "VUE") {
          e.target.style.color = "rgba(0,0,0,0)";
        ...
        if (e.target.lastChild.nodeValue === "NEXTJS") {
          e.target.style.color = "rgba(0,0,0,0)";
